...
public class PolicyHandler{
    ...
    public void wheneverCookStarted_NotifyKakaotalk(@Payload CookStarted cookStarted){
    ...
    public void wheneverCookFinished_NotifyKakaotalk(@Payload CookFinished cookFinished){
    ...
    public void wheneverDeliveryCompleted_NotifyKakaotalk(@Payload DeliveryCompleted deliveryCompleted){
